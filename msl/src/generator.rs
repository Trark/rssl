...
fn generate_intrinsic_function(
    ...
    match &intrinsic {
        ...
        Acos => invoke_simple("acos", context),
        Asin => invoke_simple("asin", context),
        Atan => invoke_simple("atan", context),
        Atan2 => invoke_simple("atan2", context),
        Cos => invoke_simple("cos", context),
        Cosh => invoke_simple("cosh", context),
        Sin => invoke_simple("sin", context),
        Sinh => invoke_simple("sinh", context),
        Sincos => unimplemented_intrinsic(),
        Tan => invoke_simple("tan", context),
        Tanh => invoke_simple("tanh", context),
        Sqrt => invoke_simple("sqrt", context),
        RcpSqrt => invoke_simple("rsqrt", context),
        Pow => invoke_simple("pow", context),
        Exp => invoke_simple("exp", context),
        Exp2 => invoke_simple("exp2", context),
        Log => invoke_simple("log", context),
        Log2 => invoke_simple("log2", context),
        Log10 => invoke_simple("log10", context),

        F16ToF32 => unimplemented_intrinsic(),
        F32ToF16 => unimplemented_intrinsic(),

        Floor => invoke_simple("floor", context),
        Ceil => invoke_simple("ceil", context),
        Trunc => invoke_simple("trunc", context),
        Round => invoke_simple("round", context),
        Frac => invoke_simple("fract", context),
        Modf => invoke_simple("modf", context),
        Fmod => invoke_simple("fmod", context),
        ...
        WaveReadLaneFirst => invoke_simple("simd_broadcast_first", context),
        WaveActiveAllEqual => unimplemented_intrinsic(),
        WaveActiveCountBits => unimplemented_intrinsic(),
        WaveActiveSum => invoke_simple("simd_sum", context),
        WaveActiveProduct => invoke_simple("simd_product", context),
        WaveActiveBitAnd => invoke_simple("simd_and", context),
        WaveActiveBitOr => invoke_simple("simd_or", context),
        WaveActiveBitXor => invoke_simple("simd_xor", context),
        WaveActiveMin => invoke_simple("simd_min", context),
        WaveActiveMax => invoke_simple("simd_max", context),

[[vk::binding(0)]] Texture2D<float4> g_input;
[[vk::binding(1)]] Texture3D<float4> g_unused;
[[vk::binding(0, 1)]] RWTexture2D<float4> g_output;
...
{
    [[vk::ext_decorate(5271)]] uint material : MATERIAL;
};
...
[[vk::ext_capability(5283)]]
float4 PSMAIN(uint pid : SV_PrimitiveID, float2 i_texcoord : TEXCOORD, uint i_material [[vk::ext_decorate(5271)]] : MATERIAL, out float4 o_target0 : SV_Target0) : SV_Target1 {
    g_input;
    g_output;

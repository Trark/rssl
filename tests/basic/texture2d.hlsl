...
void test() {
    ...
    const float4 sample_bias_status = g_input.SampleBias((SamplerState)g_sampler, float2(0.0f, 0.0f), 0.0f, int2(0, 0), 0.0f, outInt);
    const float4 sample_cmp = g_input.SampleCmp((SamplerComparisonState)g_comparisonSampler, float2(0.0f, 0.0f), 0.0f, int2(0, 0));
    const float4 sample_cmp_clamp = g_input.SampleCmp((SamplerComparisonState)g_comparisonSampler, float2(0.0f, 0.0f), 0.0f, int2(0, 0), 0.0f);
    const float4 sample_cmp_status = g_input.SampleCmp((SamplerComparisonState)g_comparisonSampler, float2(0.0f, 0.0f), 0.0f, int2(0, 0), 0.0f, outInt);
    const float4 sample_cmp_zero = g_input.SampleCmpLevelZero((SamplerComparisonState)g_comparisonSampler, float2(0.0f, 0.0f), 0.0f, int2(0, 0));
    const float4 sample_cmp_zero_status = g_input.SampleCmpLevelZero((SamplerComparisonState)g_comparisonSampler, float2(0.0f, 0.0f), 0.0f, int2(0, 0), outInt);
    const float4 gather = g_input.GatherRed((SamplerState)g_sampler, float2(0.0f, 0.0f), int2(0, 0));
    const float4 gather_status = g_input.GatherRed((SamplerState)g_sampler, float2(0.0f, 0.0f), int2(0, 0), outInt);
    const float4 gather_red = g_input.GatherRed((SamplerState)g_sampler, float2(0.0f, 0.0f), int2(0, 0));
    const float4 gather_red_status = g_input.GatherRed((SamplerState)g_sampler, float2(0.0f, 0.0f), int2(0, 0), outInt);

...
fn export_function_param(
    ...
    export_interpolation_modifier(&param.interpolation_modifier, output)?;
...
fn export_interpolation_modifier(
    ...
    if let Some(interpolation_modifier) = &interpolation_modifier {
        match interpolation_modifier {
            ...
            ir::InterpolationModifier::Point => output.push_str("point "),
            ir::InterpolationModifier::Line => output.push_str("line "),
            ir::InterpolationModifier::Triangle => output.push_str("triangle "),
            ir::InterpolationModifier::LineAdj => output.push_str("lineadj "),
            ir::InterpolationModifier::TriangleAdj => output.push_str("triangleadj "),

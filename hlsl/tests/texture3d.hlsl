...
void test() {
    ...
    const float4 sample_offset = g_input.Sample((SamplerState)g_sampler, float3(0.0, 0.0, 0.0), int3(0, 0, 0));
    const float4 sample_clamp = g_input.Sample((SamplerState)g_sampler, float3(0.0, 0.0, 0.0), int3(0, 0, 0), 0.0);
    const float4 sample_status = g_input.Sample((SamplerState)g_sampler, float3(0.0, 0.0, 0.0), int3(0, 0, 0), 0.0, outInt);
    const float4 sample_bias_base = g_input.SampleBias((SamplerState)g_sampler, float3(0.0, 0.0, 0.0), 0.0);
    const float4 sample_bias_offset = g_input.SampleBias((SamplerState)g_sampler, float3(0.0, 0.0, 0.0), 0.0, int3(0, 0, 0));
    const float4 sample_bias_clamp = g_input.SampleBias((SamplerState)g_sampler, float3(0.0, 0.0, 0.0), 0.0, int3(0, 0, 0), 0.0);
    const float4 sample_bias_status = g_input.SampleBias((SamplerState)g_sampler, float3(0.0, 0.0, 0.0), 0.0, int3(0, 0, 0), 0.0, outInt);
